              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {rows.map((row, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex flex-col sm:grid sm:grid-cols-[1fr_80px_100px_32px] gap-2 sm:items-start border sm:border-0 rounded-md p-3 sm:p-0 mb-2 sm:mb-0">
